...
const TreasurerForm = ({ form, onChange, onFileChange, mode, selectedTreasurer, errors = {} }) => {
  ...
  useEffect(() => {
    const handleImagePreview = () => {
      ...
      if (selectedTreasurer.photo && typeof selectedTreasurer.photo === 'string') {
        setPreviewImage(selectedTreasurer.photo)
      }
